...
import useRejectInstallationProofDialog from './useRejectInstallationProofDialog';

/* ─── Types ─── */
interface RejectInstallationProofDialogProps {
  open: boolean;
...
/* ─── Reject Installation Proof Dialog ─── */
export default function RejectInstallationProofDialog({
  open,
  onOpenChange,
  promotionNames,
  onSubmit,
}: RejectInstallationProofDialogProps) {
  const { t, register, errors, isSubmitting, onFormSubmit, handleOpenChange } =
    useRejectInstallationProofDialog({
      onSubmit,
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent
        ...
        aria-describedby='reject-proof-description'
      >
        {/* ── Header ── */}
        ...
        {/* ── Body ── */}
        <form id='reject-proof-form' onSubmit={onFormSubmit}>
