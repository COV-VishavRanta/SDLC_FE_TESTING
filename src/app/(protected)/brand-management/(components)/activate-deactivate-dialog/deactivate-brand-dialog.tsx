...
import { BrandType, IncompleteCampaignType } from '@/types';
...
interface DeactivateBrandDialogProps {
  brand: BrandType;
  onClose: () => void;
  handleDeactivateBrand: (id: string) => Promise<IncompleteCampaignType[] | null>;
  isUpdatingStatus: boolean;
}

export function DeactivateBrandDialog({
  brand,
  onClose,
  handleDeactivateBrand,
  isUpdatingStatus,
}: DeactivateBrandDialogProps) {
  const t = useTranslations('brandManagement.deactivateDialog');
