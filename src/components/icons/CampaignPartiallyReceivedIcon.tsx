...
export function CampaignPartiallyReceivedIcon({ className }: IconProps) {
  return (
    <svg
    ...
    >
      ...
      />
      <path
        d='M2.19336 4.6665L8.00003 7.99984L13.8067 4.6665'
        stroke='currentColor'
        strokeWidth='1.33333'
        strokeLinecap='round'
        strokeLinejoin='round'
