...
export function CampaignInProductionIcon({ className }: IconProps) {
  return (
    <svg
    ...
    >
      ...
      />
      <path
        d='M2.19336 4.66667L8.00003 8L13.8067 4.66667'
        stroke='currentColor'
        strokeWidth='1.33333'
        strokeLinecap='round'
        strokeLinejoin='round'
