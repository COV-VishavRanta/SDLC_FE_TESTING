  ...
  return (
    <OTPInput
      ...
      containerClassName={cn(
        'cn-input-otp flex items-center has-disabled:text-[var(--disabled-text)]',
        containerClassName,
      )}
      spellCheck={false}
...
function InputOTPGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'shadow-none has-aria-invalid:ring-destructive/20 dark:has-aria-invalid:ring-destructive/40 has-aria-invalid:border-destructive rounded-md flex items-center ',
        className,
      )}
      {...props}
    />
